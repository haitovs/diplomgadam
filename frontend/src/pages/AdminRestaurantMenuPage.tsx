        ...
        <div className="min-h-screen bg-slate-50 dark:bg-slate-900 transition-colors">
            ...
            <div className="max-w-7xl mx-auto p-4 sm:p-6">
                <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-3 mb-6">
                    <h2 className="text-lg sm:text-xl text-slate-900 dark:text-white font-semibold">Menýu pozisiýalary</h2>
                    <button
                        onClick={() => { setEditingItem(null); setShowForm(true); }}
                        className="self-start sm:self-auto px-4 sm:px-6 py-2 bg-gradient-to-r from-brand-600 to-brand-500 text-white font-semibold rounded-lg hover:opacity-90"
                    >
                        + Menýu goş
                    </button>
                </div>
